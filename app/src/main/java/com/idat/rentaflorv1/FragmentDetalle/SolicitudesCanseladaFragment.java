 ...
 * Use the {@link SolicitudesCanseladaFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SolicitudesCanseladaFragment extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    ArrayList<Solicitudes> listaSolicitud;
    ...
    public SolicitudesCanseladaFragment() {
     ...
     * @return A new instance of fragment SolicitudesCanseladaFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SolicitudesCanseladaFragment newInstance(String param1, String param2) {
        SolicitudesCanseladaFragment fragment = new SolicitudesCanseladaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_solicitudes_canselada, container, false);
        //recepciono los componentes de mi xml
        recyclersolicitud = view.findViewById(R.id.recyclersolicitudescanselada);
    ...
    private void cargarWSlistaSolicitudes() {
        ...
        String url = "http://192.168.100.10/rentaflor/listar_solicitud.php?estado=3&&id="+id;
    ...
    public void onErrorResponse(VolleyError error) {
        progress.hide();
        //Toast.makeText(getContext(), R.string.sms_error_de_coneccion + error.toString(), Toast.LENGTH_LONG).show();
